  ...
  Widget build(BuildContext context) => MaterialApp(
        ...
        theme: ThemeData(
          ...
          navigationBarTheme: NavigationBarThemeData(
              ...
              indicatorColor: _primary.withAlpha(22),
...
class PageHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) => LayoutBuilder(builder: (_, c) {
        ...
        if (action == null) return h;
        if (c.maxWidth < 620)
          return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [h, const SizedBox(height: 13), action!]);
        return Row(children: [Expanded(child: h), action!]);
      });
}
        ...
        child: RefreshIndicator(
            ...
            child: ListView(
                ...
                children: [
                  ...
                  const SizedBox(height: 18),
                  _HeroBanner(
                      products: products.length, onAdd: widget.onInventory),
                  const SizedBox(height: 24),
                  const _SectionTitle(title: 'Business snapshot'),
                  ...
                  _SectionTitle(
                      title: 'Low stock',
                      action: low.isEmpty ? null : 'Review items'),
                  const SizedBox(height: 10),
                  if (low.isEmpty)
                    const _EmptyCard(
                  ...
                  const SizedBox(height: 26),
                  const _SectionTitle(title: 'Recently stocked'),
                  const SizedBox(height: 10),
                  SizedBox(
                      height: 246,
...
class _HeroBanner extends StatelessWidget {
  ...
  const _HeroBanner({required this.products, this.onAdd});
  @override
  Widget build(BuildContext context) => Container(
      padding: const EdgeInsets.fromLTRB(20, 20, 14, 20),
      decoration: BoxDecoration(
          gradient: const LinearGradient(
              colors: [Color(0xFF1B1F3B), Color(0xFF3D5AFE)]),
        ...
        Expanded(
          ...
          const Text('Everything in one place',
              style: TextStyle(
                  ...
                  fontWeight: FontWeight.w900)),
          const SizedBox(height: 4),
          Text('$products products • inventory, POS and stock control',
              style:
                  TextStyle(color: Colors.white.withAlpha(200), fontSize: 12))
        ])),
...
class _CategoryCard extends StatelessWidget {
  ...
  final IconData icon;
  final Color accent;
  const _CategoryCard(this.name, this.icon, this.accent);
  @override
  Widget build(BuildContext context) => Container(
      width: 148,
...
class _ProductImageState extends State<ProductImage> {
  ...
  void initState() {
    super.initState();
    url =
        widget.product.imageUrl.trim().isEmpty ? null : widget.product.imageUrl;
    if (url == null) _lookup();
  }
  ...
  Widget build(BuildContext context) {
    final fallback = Container(
        ...
        child: Icon(categoryIcon(widget.product.category),
            size: widget.size * .42, color: _ink));
          ...
          child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    Expanded(
                        child: ProductImage(
                            product: product, size: 180, radius: 17)),
                    const SizedBox(height: 11),
                    Text(product.brand,
                        style: const TextStyle(
                            color: _muted,
...
class _InventoryPageState extends State<InventoryPage> {
  ...
  Widget build(BuildContext context) => Frame(
        ...
        Row(children: [
          const _FilterPill(label: 'All products', selected: true),
...
class _FilterPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
      ...
      decoration: BoxDecoration(
          color: selected ? _primary.withAlpha(14) : Colors.white,
          borderRadius: BorderRadius.circular(30),
          border: Border.all(
              color:
                  selected ? _primary.withAlpha(38) : const Color(0xFFE6E8EF))),
      child: Text(label,
          style: TextStyle(
...
class _ProductFormDialogState extends State<_ProductFormDialog> {
  ...
  final name = TextEditingController(),
      ...
      minimum = TextEditingController(text: '2');
  String brand = 'Samsung', category = 'Mobile Phones', imageUrl = '';
  ...
  Widget build(BuildContext context) => AlertDialog(
        title: const Column(
            ...
            children: [
              ...
              SizedBox(height: 3),
              Text('Choose type + brand first, then enter the model.',
                  style: TextStyle(
                      fontSize: 12,
                      color: _muted,
            ...
            child: Form(
                ...
                child: SingleChildScrollView(
                          ...
                          const ListTile(
                              ...
                              title: Text('Internet suggestions',
                                  style: TextStyle(
                                      ...
                                      fontSize: 13)),
                              subtitle: Text(
                                  'Tap a result to fill the model and image.',
                  ...
                  Row(children: [
                    Expanded(
                        child:
                            _field(purchase, 'Purchase price', number: true)),
                    const SizedBox(width: 10),
                    Expanded(
...
class _SalesPageState extends State<SalesPage> {
      ...
      Expanded(
          child: wide
              ...
              : Column(children: [
                  ...
                  Center(
                      child: SizedBox(
                          width: MediaQuery.sizeOf(context).width - 44 > 330
                              ? 330.0
  ...
  void _showMobileCart(double total) => showModalBottomSheet<void>(
      context: context,
      showDragHandle: true,
      builder: (_) => SafeArea(
          child: Padding(
...
class _CartButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) => DecoratedBox(
      decoration: BoxDecoration(
          gradient: enabled
              ? const LinearGradient(colors: [_primary, _purple])
              : const LinearGradient(
                  colors: [Color(0xFFDDE1EC), Color(0xFFC9CEDA)]),
          borderRadius: BorderRadius.circular(30)),
      child: Material(
          ...
          child: InkWell(
              ...
              child: Center(
                  child: Text(
                      enabled ? 'View cart • ${money(total)}' : 'Cart • ₹0',
                      style: TextStyle(
...
const _categories = <(String, IconData, Color)>[
  ('Mobile Phones', Icons.smartphone_rounded, _primary),
  ('Laptops', Icons.laptop_mac_rounded, _purple),
  ('Televisions', Icons.tv_rounded, _teal),
  ('Refrigerators', Icons.kitchen_rounded, _orange),
  ('Audio', Icons.headphones_rounded, Color(0xFFE85AAD)),
  ('Cameras', Icons.photo_camera_rounded, Color(0xFF3D7DD8)),
  ('Printers', Icons.print_rounded, Color(0xFF6B7280)),
  ('Networking', Icons.router_rounded, Color(0xFF00A884)),
];
