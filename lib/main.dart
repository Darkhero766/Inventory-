...
class _InventoryPageState extends State<InventoryPage> {
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                prefixIcon: Icon(Icons.search),
                hintText: 'Search products, brands, SKU or barcode',
              ),
            ),
  ...
  Future<void> showProductForm(BuildContext context) async {
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: field(purchase, 'Purchase price', number: true),
                      ),
                      const SizedBox(width: 10),
                      Expanded(
                        child: field(selling, 'Selling price', number: true),
                      ),
                    ],
                  ),
                  Row(
    ...
    await AppDatabase.instance.addProduct({
      ...
      'selling_price': double.tryParse(selling.text) ?? 0,
      'purchase_price': double.tryParse(purchase.text) ?? 0,
      'quantity': int.tryParse(quantity.text) ?? 0,
      'minimum_stock': int.tryParse(minimum.text) ?? 2,
      'supplier': '',
      'warranty': '',
      'gst_rate': 18,
      'hsn_code': '',
      ...
      child: Wrap(
        children: [
          ...
          ListTile(
            ...
            trailing: Text(money(p.sellingPrice)),
          ),
          ListTile(
            title: const Text('Purchase price'),
            trailing: Text(money(p.purchasePrice)),
          ),
          ListTile(
            title: const Text('Stock'),
            trailing: Text('${p.quantity} · ${p.status}'),
          ),
        ...
        child: ListView(
          children: const [
            ...
            FeatureTile(
              ...
              title: 'New Purchase',
              subtitle: 'Create a purchase and increase stock atomically',
            ),
            FeatureTile(
              icon: Icons.local_shipping_outlined,
              title: 'Suppliers',
              subtitle: 'Manage suppliers, invoices and outstanding payments',
            ),
            FeatureTile(
              icon: Icons.history,
        ...
        child: ListView(
          children: const [
            ...
            FeatureTile(
              ...
              title: 'Reports',
              subtitle: 'Sales, profit, inventory and stock movement',
            ),
            FeatureTile(
